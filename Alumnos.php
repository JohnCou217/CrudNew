...
<?php
    ...
    if (isset($_POST['cambio'])) {
        ...
        $Cambiar="UPDATE Alumnos SET nombre='$nombre',institucion='$institucion',tipoServ='$tiposerv',direccion='$direccion',numCel='$numcel',correo='$correo',numEmerg='$numemerg' WHERE IdAlumnos='$idca'";
